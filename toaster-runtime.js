// OSR virtual target runtime
// Adds support for event-card effects that place temporary no-hit targets on the target wheel.

(() => {
  if (window.__osrVirtualTargetRuntimeLoaded) return;
  window.__osrVirtualTargetRuntimeLoaded = true;
